...
public class SSLSocketWrapper extends SSLSocket
{
   ...
   public boolean       getUseClientMode()                                      { return s.getUseClientMode();         }
	...
	public void          setEnabledCipherSuites( String[] cs )                   { s.setEnabledCipherSuites( cs );      }
	public void          setEnabledProtocols( String[] ep )                      { s.setEnabledProtocols( ep );         }
	...
	public void          setEnableSessionCreation( boolean b )                   { s.setEnableSessionCreation( b );     }

	/* java.net.Socket */

	public SocketChannel getChannel()                                            { return s.getChannel();               }
	public InetAddress   getInetAddress()                                        { return s.getInetAddress();           }
	public boolean       getKeepAlive()                   throws SocketException { return s.getKeepAlive();             }
	...
	public boolean       getOOBInline()                   throws SocketException { return s.getOOBInline();             }
	...
	public int           getSendBufferSize()              throws SocketException { return s.getSendBufferSize();        }
	...
	public boolean       getTcpNoDelay()                  throws SocketException { return s.getTcpNoDelay();            }
	public int           getTrafficClass()                throws SocketException { return s.getTrafficClass();          }
	...
	public void          sendUrgentData(int data)         throws IOException     { s.sendUrgentData( data );            }
	public void          setKeepAlive(boolean on)         throws SocketException { s.setKeepAlive( on );                }
	public void          setOOBInline(boolean on)         throws SocketException { s.setOOBInline( on );                }
	...
	public void          setSendBufferSize(int size)      throws SocketException { s.setSendBufferSize( size );         }
	public void          setSoLinger(boolean on, int l)   throws SocketException { s.setSoLinger( on, l );              }
	public void          setSoTimeout(int timeout)        throws SocketException { s.setSoTimeout( timeout );           }
	public void          setTcpNoDelay(boolean on)        throws SocketException { s.setTcpNoDelay( on );               }
	public void          setTrafficClass(int tc)          throws SocketException { s.setTrafficClass( tc );             }
